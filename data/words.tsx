...
const words: Word[] = [
  ...
  {
    german: "behaupten",
    meaning: "etwas als wahr darstellen",
    translation: "to claim",
    example1: "Er behauptet, unschuldig zu sein.",
    sentenceTranslation1: "He claims to be innocent.",
    example2: "Sie behauptete, die Wahrheit zu kennen.",
    sentenceTranslation2: "She claimed to know the truth.",
    type: "verb",
  },
  {
    german: "bekämpfen",
  ...
  {
    german: "erleben",
    meaning: "etwas erfahren oder durchmachen",
    translation: "to experience",
    example1: "Sie hat viel in ihrem Leben erlebt.",
    sentenceTranslation1: "She has experienced a lot in her life.",
    example2: "Wir erlebten einen unvergesslichen Abend.",
    sentenceTranslation2: "We experienced an unforgettable evening.",
    type: "verb",
  },
  {
    german: "erzielen",
  ...
  {
    german: "fördern",
    meaning: "etwas unterstützen oder fördern",
    translation: "to promote",
    example1: "Die Regierung fördert den Umweltschutz.",
    sentenceTranslation1: "The government promotes environmental protection.",
    example2: "Der Lehrer fördert die Kreativität seiner Schüler.",
    sentenceTranslation2: "The teacher promotes his students' creativity.",
    type: "verb",
  },
  {
    german: "gestalten",
    meaning: "etwas formen oder gestalten",
    translation: "to design",
    example1: "Sie gestaltete den Raum neu.",
    sentenceTranslation1: "She redesigned the room.",
    example2: "Wir müssen die Zukunft aktiv gestalten.",
    sentenceTranslation2: "We need to actively shape the future.",
    type: "verb",
  },
];
